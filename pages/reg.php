...
echo "<a class='person' href='pages/viewuser.php?id=".$array0['id']."'><button type='submit'>".$array0['login']."</button></a>,";
    ...
    <div class="nav-wrapper xxx">
      <div class="col s12">
		...
		<a href="#!" class="breadcrumb">Регистрация</a>
      </div>
    </div>
  </nav>
...
<!--**** save_user.php - это адрес обработчика. То есть, после нажатия на кнопку "Зарегистрироваться", данные из полей отправятся на страничку save_user.php методом "post" ***** -->
  <p>
    ...
    <input required  name="name" type="text" size="15" maxlength="40">
  </p>
      <p>
    <label>Ваша фамилия:<br></label>
    <input required  name="lastname" type="text" size="15" maxlength="40">
  </p>
    <p>
    <label>Ваш возраст:<br></label>
    <input required  name="age" type="text" size="15" maxlength="3">
  </p>
      <p>
    <label>О себе:<br></label>
    <textarea required  name="aboutme" type="text" size="40" maxlength="300"></textarea>
  </p>
